# PCA
This script simple script is good when you have whole-genome data and you want to run PCA. The VCF files are heavy and hard to handle on your local computer. You can prepare the plink files like this to get a much more manageable size.
